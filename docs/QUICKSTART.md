...
The dev command automatically creates a development subreddit for your app and a test post for you to develop against. When you visit the url, it should look something like the screenshot in the Devvit docs.
...
```json
"scripts": {    //...    "dev": "devvit playtest r/MY_PREFERRED_SUBREDDIT",    //...}
```
...
Use our launch guide (https://developers.reddit.com/docs/guides/launch/launch-guide) to guide you where to get your first users.
...
- Launching and Promoting your game: https://developers.reddit.com/docs/guides/launch/launch-guide
