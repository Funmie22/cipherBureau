import { type AppInstall, type AppUpgrade, type AutomoderatorFilterComment, type AutomoderatorFilterPost, type CommentCreate, type CommentDelete, type CommentReport, type CommentSubmit, type CommentUpdate, type MentionInCommentCreate, type PostCreate, type PostDelete, type PostFlairUpdate, type PostNsfwUpdate, type PostReport, type PostSpoilerUpdate, type PostSubmit, type PostUpdate } from '@devvit/protos/json/devvit/events/v1alpha/events.js';
...
export type TriggerRequest = OnAppInstallRequest | OnAppUpgradeRequest | OnAutomoderatorFilterCommentRequest | OnAutomoderatorFilterPostRequest | OnCommentCreateRequest | OnCommentDeleteRequest | OnCommentReportRequest | OnCommentSubmitRequest | OnCommentUpdateRequest | OnMentionInCommentCreateRequest | OnModActionRequest | OnModMailRequest | OnPostCreateRequest | OnPostDeleteRequest | OnPostFlairUpdateRequest | OnPostNsfwUpdateRequest | OnPostReportRequest | OnPostSpoilerUpdateRequest | OnPostSubmitRequest | OnPostUpdateRequest;
