...
import { OnAppInstallDefinition, OnAppUpgradeDefinition, OnAutomoderatorFilterCommentDefinition, OnAutomoderatorFilterPostDefinition, OnCommentCreateDefinition, OnCommentDeleteDefinition, OnCommentReportDefinition, OnCommentSubmitDefinition, OnCommentUpdateDefinition, OnMentionInCommentCreateDefinition, OnModActionDefinition, OnModMailDefinition, OnPostCreateDefinition, OnPostDeleteDefinition, OnPostFlairUpdateDefinition, OnPostNsfwUpdateDefinition, OnPostReportDefinition, OnPostSpoilerUpdateDefinition, OnPostSubmitDefinition, OnPostUpdateDefinition, } from '@devvit/protos/types/devvit/actor/automation/v1alpha/event_handlers.js';
    ...
    for (const event of Devvit.triggerOnEventHandlers.keys()) {
        switch (event) {
            ...
            case 'MentionInCommentCreate':
                ...
                extendDevvitPrototype('OnMentionInCommentCreate', createCombinedHandler('MentionInCommentCreate', Devvit.triggerOnEventHandlers.get(event)));
                break;
            case 'AppInstall':
