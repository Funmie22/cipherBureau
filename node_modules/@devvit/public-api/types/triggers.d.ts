...
export type TriggerEvent = PostSubmit | PostCreate | PostUpdate | PostReport | PostDelete | PostFlairUpdate | CommentSubmit | CommentCreate | CommentUpdate | CommentReport | CommentDelete | MentionInCommentCreate | AppInstall | AppUpgrade | ModActionTrigger | ModMailTrigger | PostNsfwUpdate | PostSpoilerUpdate | AutomoderatorFilterPost | AutomoderatorFilterComment;
...
export type TriggerDefinition = PostSubmitDefinition | PostCreateDefinition | PostUpdateDefinition | PostFlairUpdateDefinition | PostReportDefinition | PostDeleteDefinition | CommentSubmitDefinition | CommentCreateDefinition | CommentUpdateDefinition | CommentReportDefinition | CommentDeleteDefinition | MentionInCommentCreateDefinition | AppInstallDefinition | AppUpgradeDefinition | ModActionDefinition | ModMailDefinition | PostSpoilerUpdateDefinition | PostNsfwUpdateDefinition | OnAutomoderatorFilterPostDefinition | OnAutomoderatorFilterCommentDefinition;
export type OnTriggerRequest = Events.PostFlairUpdate | Events.PostSubmit | Events.PostCreate | Events.PostUpdate | Events.PostReport | Events.PostDelete | Events.CommentSubmit | Events.CommentCreate | Events.CommentUpdate | Events.CommentReport | Events.CommentDelete | Events.MentionInCommentCreate | Events.AppInstall | Events.AppUpgrade | ModAction | ModMail | Events.PostNsfwUpdate | Events.PostSpoilerUpdate | Events.AutomoderatorFilterPost | Events.AutomoderatorFilterComment;
