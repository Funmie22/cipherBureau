...
enum NutritionCategory {
  ...
  // Note: CUSTOM_POST is a subset of UI: if CUSTOM_POST is set then UI is set also.
  CUSTOM_POST = 13;
  // App may invoke Reddit APIs on behalf of the user.
  USER_ACTIONS = 14;
  // App may be invoked by third-parties outside of Reddit.
  EXTERNAL_ENDPOINTS = 15;
  // App may record user journeys with Devvit telemetry.
  JOURNEYS = 16;
}
