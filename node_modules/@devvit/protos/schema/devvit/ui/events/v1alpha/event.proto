...
// Devvit Classic events. Most are deprecated. Don't add Webbit events here.
message UIEvent {
  oneof event {
    devvit.ui.effects.v1alpha.RealtimeSubscriptionEvent realtime_event = 2 [deprecated = true];
    devvit.ui.effect_types.v1alpha.FormSubmittedEvent form_submitted = 3;
    devvit.ui.effect_types.v1alpha.OrderResultEvent order_result = 19 [deprecated = true];
    devvit.ui.effect_types.v1alpha.ToastActionEvent toast_action = 4 [deprecated = true];
    UserAction user_action = 6 [deprecated = true];
    AsyncRequest async_request = 7 [deprecated = true];
    AsyncResponse async_response = 8 [deprecated = true];
    TimerEvent timer = 12 [deprecated = true];
    BlockingRenderEvent blocking = 13 [deprecated = true];
    ResizeEvent resize = 14 [deprecated = true];
    WebViewEvent web_view = 20 [deprecated = true];
    devvit.ui.effect_types.v1alpha.FormCanceledEvent form_canceled = 21;
    devvit.ui.effect_types.v1alpha.ConsentStatusEvent consent_status = 23 [deprecated = true];
  }
