...
/**
 * Render-time ad data for promoted Devvit posts. Populated by the client
 * (Shreddit, iOS, Android) from the AdPost GraphQL payload. Absent for
 * non-promoted posts.
 * Total serialized JSON size must be <= 2 KB. This is not intended for large
 * payloads (e.g. raw image data).
 */
export interface AdPayload {
    /**
     * Arbitrary ad-side render-time data. Eg, { "clickUrl": "https://alb…" }.
     * Shape is owned by Ads and may evolve without proto changes.
     */
    data?: {
        [key: string]: any;
    } | undefined;
...
export declare const AdPayload: {
    $type: "devvit.ui.effects.web_view.v1alpha.AdPayload";
    encode(message: AdPayload, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): AdPayload;
    fromJSON(object: any): AdPayload;
    toJSON(message: AdPayload): unknown;
    create(base?: DeepPartial<AdPayload>): AdPayload;
    fromPartial(object: DeepPartial<AdPayload>): AdPayload;
};
