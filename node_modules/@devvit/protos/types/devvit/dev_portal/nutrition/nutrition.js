...
(function (NutritionCategory) {
    ...
    /** USER_ACTIONS - App may invoke Reddit APIs on behalf of the user. */
    NutritionCategory[NutritionCategory["USER_ACTIONS"] = 14] = "USER_ACTIONS";
    /** EXTERNAL_ENDPOINTS - App may be invoked by third-parties outside of Reddit. */
    NutritionCategory[NutritionCategory["EXTERNAL_ENDPOINTS"] = 15] = "EXTERNAL_ENDPOINTS";
    /** JOURNEYS - App may record user journeys with Devvit telemetry. */
    NutritionCategory[NutritionCategory["JOURNEYS"] = 16] = "JOURNEYS";
...
export function nutritionCategoryToJSON(object) {
    switch (object) {
        ...
        case NutritionCategory.USER_ACTIONS:
            return 14;
        case NutritionCategory.EXTERNAL_ENDPOINTS:
            return 15;
        case NutritionCategory.JOURNEYS:
            return 16;
