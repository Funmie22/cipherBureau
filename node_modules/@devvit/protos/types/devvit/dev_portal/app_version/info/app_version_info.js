...
import { nutritionCategoryFromJSON, nutritionCategoryToJSON } from "../../nutrition/nutrition.js";
...
function createBaseAppVersionInfo() {
    return {
        ...
        pool: 0,
        appCapabilities: [],
        publicApiVersion: undefined,
        marketingInfo: undefined,
        hasDevvitJson: false,
        sourceUploadInfo: undefined,
        hasChromelessPermission: false,
    };
}
export const AppVersionInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.appCapabilities) {
            writer.int32(v);
        }
        writer.ldelim();
        if (message.publicApiVersion !== undefined) {
            writer.uint32(138).string(message.publicApiVersion);
        }
        if (message.marketingInfo !== undefined) {
            AppVersionMarketingInfo.encode(message.marketingInfo, writer.uint32(146).fork()).ldelim();
        }
        if (message.hasDevvitJson !== false) {
            writer.uint32(152).bool(message.hasDevvitJson);
        }
        if (message.sourceUploadInfo !== undefined) {
            SourceUploadInfo.encode(message.sourceUploadInfo, writer.uint32(162).fork()).ldelim();
        }
        if (message.hasChromelessPermission !== false) {
            writer.uint32(168).bool(message.hasChromelessPermission);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 16:
                    if (tag === 128) {
                        message.appCapabilities.push(reader.int32());
                        continue;
                    }
                    if (tag === 130) {
                        const end2 = reader.uint32() + reader.pos;
                ...
                case 18:
                    ...
                    message.marketingInfo = AppVersionMarketingInfo.decode(reader, reader.uint32());
                    continue;
                case 19:
                    if (tag !== 152) {
                        break;
                    }
                    message.hasDevvitJson = reader.bool();
                    continue;
                case 20:
                    if (tag !== 162) {
                        break;
                    }
                    message.sourceUploadInfo = SourceUploadInfo.decode(reader, reader.uint32());
                    continue;
                case 21:
                    if (tag !== 168) {
                        break;
                    }
                    message.hasChromelessPermission = reader.bool();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            appCapabilities: globalThis.Array.isArray(object?.appCapabilities)
                ? object.appCapabilities.map((e) => nutritionCategoryFromJSON(e))
                : [],
            publicApiVersion: isSet(object.publicApiVersion) ? globalThis.String(object.publicApiVersion) : undefined,
            marketingInfo: isSet(object.marketingInfo) ? AppVersionMarketingInfo.fromJSON(object.marketingInfo) : undefined,
            hasDevvitJson: isSet(object.hasDevvitJson) ? globalThis.Boolean(object.hasDevvitJson) : false,
            sourceUploadInfo: isSet(object.sourceUploadInfo) ? SourceUploadInfo.fromJSON(object.sourceUploadInfo) : undefined,
            hasChromelessPermission: isSet(object.hasChromelessPermission)
                ? globalThis.Boolean(object.hasChromelessPermission)
                : false,
        };
    },
    toJSON(message) {
        ...
        if (message.appCapabilities?.length) {
            obj.appCapabilities = message.appCapabilities.map((e) => nutritionCategoryToJSON(e));
        }
        if (message.publicApiVersion !== undefined) {
            obj.publicApiVersion = message.publicApiVersion;
        }
        if (message.marketingInfo !== undefined) {
            obj.marketingInfo = AppVersionMarketingInfo.toJSON(message.marketingInfo);
        }
        if (message.hasDevvitJson !== false) {
            obj.hasDevvitJson = message.hasDevvitJson;
        }
        if (message.sourceUploadInfo !== undefined) {
            obj.sourceUploadInfo = SourceUploadInfo.toJSON(message.sourceUploadInfo);
        }
        if (message.hasChromelessPermission !== false) {
            obj.hasChromelessPermission = message.hasChromelessPermission;
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.appCapabilities = object.appCapabilities?.map((e) => e) || [];
        message.publicApiVersion = object.publicApiVersion ?? undefined;
        message.marketingInfo = (object.marketingInfo !== undefined && object.marketingInfo !== null)
            ? AppVersionMarketingInfo.fromPartial(object.marketingInfo)
            : undefined;
        message.hasDevvitJson = object.hasDevvitJson ?? false;
        message.sourceUploadInfo = (object.sourceUploadInfo !== undefined && object.sourceUploadInfo !== null)
            ? SourceUploadInfo.fromPartial(object.sourceUploadInfo)
            : undefined;
        message.hasChromelessPermission = object.hasChromelessPermission ?? false;
        return message;
    },
};
messageTypeRegistry.set(AppVersionInfo.$type, AppVersionInfo);
function createBaseSourceUploadInfo() {
    return { uploadUrl: undefined, requiredHeaders: {}, s3ObjectKey: undefined };
}
export const SourceUploadInfo = {
    $type: "devvit.dev_portal.app_version.info.SourceUploadInfo",
    encode(message, writer = _m0.Writer.create()) {
        if (message.uploadUrl !== undefined) {
            writer.uint32(10).string(message.uploadUrl);
        }
        Object.entries(message.requiredHeaders).forEach(([key, value]) => {
            SourceUploadInfo_RequiredHeadersEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        if (message.s3ObjectKey !== undefined) {
            writer.uint32(26).string(message.s3ObjectKey);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseSourceUploadInfo();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    const entry2 = SourceUploadInfo_RequiredHeadersEntry.decode(reader, reader.uint32());
                    if (entry2.value !== undefined) {
                        message.requiredHeaders[entry2.key] = entry2.value;
                    }
                    continue;
                case 3:
                    if (tag !== 26) {
    ...
    fromJSON(object) {
        return {
            ...
            requiredHeaders: isObject(object.requiredHeaders)
                ? Object.entries(object.requiredHeaders).reduce((acc, [key, value]) => {
                    acc[key] = String(value);
                    return acc;
                }, {})
                : {},
            s3ObjectKey: isSet(object.s3ObjectKey) ? globalThis.String(object.s3ObjectKey) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.requiredHeaders) {
            const entries = Object.entries(message.requiredHeaders);
            if (entries.length > 0) {
                obj.requiredHeaders = {};
                entries.forEach(([k, v]) => {
                    obj.requiredHeaders[k] = v;
                });
            }
        }
        if (message.s3ObjectKey !== undefined) {
    ...
    create(base) {
        return SourceUploadInfo.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSourceUploadInfo();
        message.uploadUrl = object.uploadUrl ?? undefined;
        message.requiredHeaders = Object.entries(object.requiredHeaders ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
messageTypeRegistry.set(SourceUploadInfo.$type, SourceUploadInfo);
function createBaseSourceUploadInfo_RequiredHeadersEntry() {
    return { key: "", value: "" };
}
export const SourceUploadInfo_RequiredHeadersEntry = {
    $type: "devvit.dev_portal.app_version.info.SourceUploadInfo.RequiredHeadersEntry",
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseSourceUploadInfo_RequiredHeadersEntry();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return SourceUploadInfo_RequiredHeadersEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSourceUploadInfo_RequiredHeadersEntry();
...
messageTypeRegistry.set(SourceUploadInfo_RequiredHeadersEntry.$type, SourceUploadInfo_RequiredHeadersEntry);
function createBaseAppVersionMarketingInfo() {
    return { icon: undefined };
}
export const AppVersionMarketingInfo = {
    $type: "devvit.dev_portal.app_version.info.AppVersionMarketingInfo",
    encode(message, writer = _m0.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseAppVersionMarketingInfo();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return { icon: isSet(object.icon) ? globalThis.String(object.icon) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.icon !== undefined) {
    ...
    create(base) {
        return AppVersionMarketingInfo.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAppVersionMarketingInfo();
...
messageTypeRegistry.set(AppVersionMarketingInfo.$type, AppVersionMarketingInfo);
