 ...
 */
import type { NutritionCategory } from "../../nutrition/nutrition.js";
...
export type OptionalVersionVisibility = {
...
export type SourceUploadInfo_RequiredHeadersEntry = {
    key: string;
    value: string;
};
/** Contains marketing information about an app version, such as its icon. */
export type AppVersionMarketingInfo = {
    /**
