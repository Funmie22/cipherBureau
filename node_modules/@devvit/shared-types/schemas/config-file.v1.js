                ...
                partial.server.externalEndpoints[name] = {
                    ...
                    scopes: (config.scopes ??
                        schema.$defs.ExternalEndpoint.properties.scopes
                            .default).map(externalEndpointsScopeFromJSON),
                };
        }
    }
...
function AppPermissionConfig(permissions, partial) {
    ...
    return {
        ...
        chromeless: permissions?.chromeless ?? schema.properties.permissions.properties.chromeless.default,
...
function externalEndpointsScopeFromJSON(scope) {
    switch (scope) {
        default:
            scope;
        // fallthrough
